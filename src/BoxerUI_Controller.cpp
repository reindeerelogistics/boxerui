...
namespace BoxerUI {
	...
	{
		boxerView.signinWindow(boxer_analytics);
	}
	...
	void BoxerUI_Controller::cameraView()
	{
		...
		//first_time = false;
		//boxerView.viewDockspace();

	}

	bool BoxerUI_Controller::destroyCamThreads() {
		return boxerView.camera_stream.destroyCamThreads();
	}
}