...
// face detect example: https://www.analyticsvidhya.com/blog/2019/03/opencv-functions-computer-vision-python/#h2_31
//using CameraMapValue = std::unique_ptr<std::queue<cv::Mat >>;
